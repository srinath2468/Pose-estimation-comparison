#!/usr/bin/env python  
'''
[ INFO] [1552058800.390182794]: 3) TOPIC STREAM:
[ INFO] [1552058800.391499139]: hand_camera: 
translation: 
  x: -0.979252
  y: -0.393149
  z: 0.468526
...
class FixedTFBroadcaster:
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            t_cam_world.transform.translation.x = -0.979252
            t_cam_world.transform.translation.y = -0.393149
            t_cam_world.transform.translation.z =0.468526
            t_cam_world.transform.rotation.x =  -0.721323
            t_cam_world.transform.rotation.y = 0.314279
            t_cam_world.transform.rotation.z = -0.275834
            t_cam_world.transform.rotation.w =  0.552121
	    ...
	    t_map_world = geometry_msgs.msg.TransformStamped()
            ...
            t_map_world.transform.translation.x = -0.979252
            t_map_world.transform.translation.y =-0.393149
            t_map_world.transform.translation.z =0.468526
