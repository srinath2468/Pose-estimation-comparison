#!/usr/bin/env python  
'''
[ INFO] [1552063189.764186121]: 3) TOPIC STREAM:
[ INFO] [1552063189.766080181]: hand_camera: 
translation: 
  x: -0.974227
  y: -0.368394
  z: 0.495333
...
class FixedTFBroadcaster:
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            t_cam_world.transform.translation.x =  -0.974227
            t_cam_world.transform.translation.y = -0.368394
            t_cam_world.transform.translation.z = 0.495333
            t_cam_world.transform.rotation.x =  -0.731162
            t_cam_world.transform.rotation.y =   0.329448
            t_cam_world.transform.rotation.z = -0.26476
            t_cam_world.transform.rotation.w =  0.535507
	    ...
	    t_map_world = geometry_msgs.msg.TransformStamped()
            ...
            t_map_world.transform.translation.x =  -0.974227
            t_map_world.transform.translation.y = -0.368394
            t_map_world.transform.translation.z = 0.495333
