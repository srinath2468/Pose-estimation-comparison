#!/usr/bin/env python  
'''
[ INFO] [1552064914.978838168]: 3) TOPIC STREAM:
[ INFO] [1552064914.982756606]: hand_camera: 
translation: 
  x: -0.97478
  y: -0.369414
  z: 0.496751
...
class FixedTFBroadcaster:
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            t_cam_world.transform.translation.x = -0.97478
            t_cam_world.transform.translation.y =  -0.369414
            t_cam_world.transform.translation.z =  0.496751
            t_cam_world.transform.rotation.x =   -0.731833
            t_cam_world.transform.rotation.y =  0.330354
            t_cam_world.transform.rotation.z =-0.264179
            t_cam_world.transform.rotation.w = 0.534318
	    ...
	    t_map_world = geometry_msgs.msg.TransformStamped()
            ...
            t_map_world.transform.translation.x = -0.97478
            t_map_world.transform.translation.y = -0.369414
            t_map_world.transform.translation.z =0.496751
