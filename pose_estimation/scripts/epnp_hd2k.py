...
'''
[ INFO] [1552060212.926935247]: 3) TOPIC STREAM:
[ INFO] [1552060212.928774697]: hand_camera: 
translation: 
  x: -0.959013
  y: -0.430216
  z: 0.486737
...
class FixedTFBroadcaster:
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            t_cam_world.transform.translation.x = -0.959013
            t_cam_world.transform.translation.y = -0.430216
            t_cam_world.transform.translation.z =  0.486737
            t_cam_world.transform.rotation.x =  -0.736094
            t_cam_world.transform.rotation.y =  0.289482
            t_cam_world.transform.rotation.z = -0.26653
            t_cam_world.transform.rotation.w =  0.550751
	    ...
	    t_map_world = geometry_msgs.msg.TransformStamped()
            ...
            t_map_world.transform.translation.x = -0.959013
            t_map_world.transform.translation.y = -0.430216
            t_map_world.transform.translation.z = 0.486737
