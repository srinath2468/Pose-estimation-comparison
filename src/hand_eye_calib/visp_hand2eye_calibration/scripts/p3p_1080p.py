...
'''
[ INFO] [1552062065.384504174]: 3) TOPIC STREAM:
[ INFO] [1552062065.386177911]: hand_camera: 
translation: 
  x: -0.964952
  y: -0.421507
  z: 0.470926
...
class FixedTFBroadcaster:
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            t_cam_world.transform.translation.x = -0.964952
            t_cam_world.transform.translation.y =  -0.421507
            t_cam_world.transform.translation.z =0.470926
            t_cam_world.transform.rotation.x =  -0.724473
            t_cam_world.transform.rotation.y =  0.309403
            t_cam_world.transform.rotation.z = -0.25567
            t_cam_world.transform.rotation.w =  0.560394
	    ...
	    t_map_world = geometry_msgs.msg.TransformStamped()
            ...
            t_map_world.transform.translation.x = -0.964952
            t_map_world.transform.translation.y = -0.421507
            t_map_world.transform.translation.z =0.470926
