...
'''
[ INFO] [1552061504.245418899]: 3) TOPIC STREAM:
[ INFO] [1552061504.246879465]: hand_camera: 
translation: 
  x: -0.976397
  y: -0.390887
  z: 0.47544
...
class FixedTFBroadcaster:
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            t_cam_world.transform.translation.x =  -0.976397
            t_cam_world.transform.translation.y = -0.390887
            t_cam_world.transform.translation.z =0.47544
            t_cam_world.transform.rotation.x =  -0.724385
            t_cam_world.transform.rotation.y =  0.312658
            t_cam_world.transform.rotation.z = -0.271842
            t_cam_world.transform.rotation.w =  0.551011
	    ...
	    t_map_world = geometry_msgs.msg.TransformStamped()
            ...
            t_map_world.transform.translation.x =  -0.976397
            t_map_world.transform.translation.y = -0.390887
            t_map_world.transform.translation.z =0.47544
