...
class FixedTFBroadcaster:
    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            t_cam_world.transform.translation.x = -0.975523
            t_cam_world.transform.translation.y = -0.362947
            t_cam_world.transform.translation.z = 0.499818

            t_cam_world.transform.rotation.x =  -0.72896
            t_cam_world.transform.rotation.y = 0.334502
            t_cam_world.transform.rotation.z = -0.264367
            t_cam_world.transform.rotation.w =  0.53557
	    ...
	    t_map_world = geometry_msgs.msg.TransformStamped()
            ...
            t_map_world.transform.translation.x = -0.975523
            t_map_world.transform.translation.y = -0.362947
            t_map_world.transform.translation.z = 0.499818
