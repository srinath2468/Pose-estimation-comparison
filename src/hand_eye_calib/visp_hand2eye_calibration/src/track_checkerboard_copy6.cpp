...
//   Eigen::Quaterniond q(mat);
  ...
  rotations[0][0]= rot[1][1];
  rotations[0][1] = rot[1][0];
  rotations[0][2] = rot[1][2];
  
  rotations[1][0] = rot[0][1];
  rotations[1][1] = rot[0][0];
  rotations[1][2] = rot[0][2];
  
  rotations[2][0] = rot[2][1];
  rotations[2][1] = rot[2][0];
  rotations[2][2] = rot[2][2];
  ...
  q_.setRPY(y,r,p);
  q_.setW(-q_.w());
//   rotations.getRotation(q_);
//   tf::Quaternion q2;
//   final_pose = rotate_about_y(reoriented_pose);
//   
//   double r,p,y;
//   
//   q2.setX(final_pose.pose.orientation.x);
//   q2.setY(final_pose.pose.orientation.y);
//   q2.setZ(final_pose.pose.orientation.z);
//   q2.setW(final_pose.pose.orientation.w);  
//   tf::Matrix3x3(q2).getRPY(r,p,y);
//   q2.setRPY(y,-p,r);
//   final_pose.pose.orientation.x = q2.x();
//   final_pose.pose.orientation.y = q2.y();
//   final_pose.pose.orientation.z = q2.z();
//   final_pose.pose.orientation.w = q2.w();
  
//   final_pose = rotate_about_x(final_pose);
//   
//   
//   tf::Matrix3x3(q2).getRPY(r,p,y);
//   q2.setRPY(r,p,y);
...
//   
  ...
  final_pose.pose.orientation.x = q_.x();
  final_pose.pose.orientation.y = q_.y();
  final_pose.pose.orientation.z = q_.z();
  final_pose.pose.orientation.w = q_.w();
  final_pose.pose.position.x = inCloud->points[index].x;
  final_pose.pose.position.y = inCloud->points[index].y;
  final_pose.pose.position.z = inCloud->points[index].z;
  
  
  
  cam_obj_pose_pub.publish(final_pose);
