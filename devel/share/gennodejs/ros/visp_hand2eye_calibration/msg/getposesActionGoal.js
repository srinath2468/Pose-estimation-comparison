...
let getposesGoal = require('./getposesGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class getposesActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = getposesGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new getposesActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = getposesGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new getposesGoal()
    }
...
module.exports = getposesActionGoal;
