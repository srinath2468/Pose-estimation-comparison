...
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(MarkerMapPoseEstimationConfig::AbstractParamDescriptionConstPtr(new MarkerMapPoseEstimationConfig::ParamDescription<int>("pose_estimation_type", "int", 0, "Pose estimation type", "{'enum_description': 'Pose estimation type', 'enum': [{'srcline': 8, 'description': 'OpenCV ITERATIVE', 'srcfile': '/home/srinath/catkin_thesis/src/tuw_marker_detection/tuw_marker_pose_estimation/cfg/MarkerMapPoseEstimation.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'OPENCV_ITERATIVE'}]}", &MarkerMapPoseEstimationConfig::pose_estimation_type)));
//#line 290 "/opt/ros/kinetic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 8 "/home/srinath/catkin_thesis/src/tuw_marker_detection/tuw_marker_pose_estimation/cfg/MarkerMapPoseEstimation.cfg"
